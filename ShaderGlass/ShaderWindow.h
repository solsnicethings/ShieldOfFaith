...
private:
    ...
    ShaderMessageWindow m_ipcWindow {ShaderMessageWindow()};
    public:
...
private:
    ...
    void ipc_update_layout();
    static void ipc_update_layout_callback(IPCWindow * ipc);
    static void ipc_new_profile(IPCWindow* win);
    static void ipc_new_shader(IPCWindow* win);
};