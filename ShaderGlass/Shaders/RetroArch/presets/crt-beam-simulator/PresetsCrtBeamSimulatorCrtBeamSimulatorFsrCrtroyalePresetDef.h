/*
ShaderGlass preset presets/crt-beam-simulator / crt-beam-simulator-fsr-crtroyale imported from RetroArch:
https://github.com/libretro/slang-shaders/blob/f1796f6f744c32da57b9d8c27ea1a20160128696/presets/crt-beam-simulator/crt-beam-simulator-fsr-crtroyale.slangp
...
namespace RetroArch
{
class PresetsCrtBeamSimulatorCrtBeamSimulatorFsrCrtroyalePresetDef : public PresetDef
{
public:
	PresetsCrtBeamSimulatorCrtBeamSimulatorFsrCrtroyalePresetDef() : PresetDef{}
	{
		Name = "crt-beam-simulator-fsr-crtroyale";
