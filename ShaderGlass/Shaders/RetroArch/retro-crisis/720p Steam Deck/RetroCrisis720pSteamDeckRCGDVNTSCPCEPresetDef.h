/*
ShaderGlass preset retro-crisis/720p-Steam-Deck / RC GDV-NTSC - PCE imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis720pSteamDeckRCGDVNTSCPCEPresetDef : public PresetDef
{
public:
	RetroCrisis720pSteamDeckRCGDVNTSCPCEPresetDef() : PresetDef{}
	{
		Name = "RC GDV-NTSC - PCE";
...
.Param("wrap_mode", "clamp_to_border"));
            OverrideParam("beam_max", (float)0.999995);
            OverrideParam("bloom", (float)0.400000);
            OverrideParam("double_slot", (float)3.000000);
            OverrideParam("gsl", (float)2.000000);
            OverrideParam("halation", (float)0.100001);
            OverrideParam("m_glow", (float)1.000000);
            OverrideParam("mask_bloom", (float)0.000001);
            OverrideParam("mask_gamma", (float)2.000000);
            ...
            OverrideParam("ntsc_cscale", (float)1.999999);
            OverrideParam("ntsc_fields", (float)0.000000);
            OverrideParam("ntsc_phase", (float)3.000000);
            OverrideParam("ntsc_sat", (float)1.200000);
            OverrideParam("ntsc_scale", (float)1.200000);
            OverrideParam("scangamma", (float)3.000000);
