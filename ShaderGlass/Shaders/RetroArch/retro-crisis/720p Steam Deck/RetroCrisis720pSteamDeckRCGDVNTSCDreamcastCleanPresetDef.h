/*
ShaderGlass preset retro-crisis/720p-Steam-Deck / RC GDV-NTSC - Dreamcast - Clean imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis720pSteamDeckRCGDVNTSCDreamcastCleanPresetDef : public PresetDef
{
public:
	RetroCrisis720pSteamDeckRCGDVNTSCDreamcastCleanPresetDef() : PresetDef{}
	{
		Name = "RC GDV-NTSC - Dreamcast - Clean";
