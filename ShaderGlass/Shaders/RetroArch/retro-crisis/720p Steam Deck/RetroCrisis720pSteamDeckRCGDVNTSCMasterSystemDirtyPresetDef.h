/*
ShaderGlass preset retro-crisis/720p-Steam-Deck / RC GDV-NTSC - Master System - Dirty imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis720pSteamDeckRCGDVNTSCMasterSystemDirtyPresetDef : public PresetDef
{
public:
	RetroCrisis720pSteamDeckRCGDVNTSCMasterSystemDirtyPresetDef() : PresetDef{}
	{
		Name = "RC GDV-NTSC - Master System - Dirty";
...
.Param("wrap_mode", "clamp_to_border"));
            ...
            OverrideParam("ntsc_scale", (float)0.749999);
