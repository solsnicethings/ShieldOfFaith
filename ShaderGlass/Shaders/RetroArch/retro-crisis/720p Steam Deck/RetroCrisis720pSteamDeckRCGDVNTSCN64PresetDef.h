/*
ShaderGlass preset retro-crisis/720p-Steam-Deck / RC GDV-NTSC - N64 imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis720pSteamDeckRCGDVNTSCN64PresetDef : public PresetDef
{
public:
	RetroCrisis720pSteamDeckRCGDVNTSCN64PresetDef() : PresetDef{}
	{
		Name = "RC GDV-NTSC - N64";
...
.Param("wrap_mode", "clamp_to_border"));
            ...
            OverrideParam("blendMode", (float)0.000000);
            OverrideParam("bloom", (float)0.050000);
            OverrideParam("double_slot", (float)3.000000);
            OverrideParam("gamma_c", (float)1.250000);
