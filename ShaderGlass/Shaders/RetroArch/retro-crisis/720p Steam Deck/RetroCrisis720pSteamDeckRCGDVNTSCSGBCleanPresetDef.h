/*
ShaderGlass preset retro-crisis/720p-Steam-Deck / RC GDV-NTSC - SGB - Clean imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis720pSteamDeckRCGDVNTSCSGBCleanPresetDef : public PresetDef
{
public:
	RetroCrisis720pSteamDeckRCGDVNTSCSGBCleanPresetDef() : PresetDef{}
	{
		Name = "RC GDV-NTSC - SGB - Clean";
