/*
ShaderGlass preset retro-crisis/720p-Steam-Deck / RC GDV-NTSC - Arcade - Dirty imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis720pSteamDeckRCGDVNTSCArcadeDirtyPresetDef : public PresetDef
{
public:
	RetroCrisis720pSteamDeckRCGDVNTSCArcadeDirtyPresetDef() : PresetDef{}
	{
		Name = "RC GDV-NTSC - Arcade - Dirty";
...
.Param("wrap_mode", "clamp_to_border"));
            ...
            OverrideParam("beam_max", (float)1.100000);
            ...
            OverrideParam("deconrry", (float)-3.500000);
            ...
            OverrideParam("ntsc_cscale", (float)2.099999);
            OverrideParam("ntsc_cscale1", (float)0.650000);
            OverrideParam("ntsc_gamma", (float)0.250000);
            OverrideParam("ntsc_sat", (float)1.100001);
            OverrideParam("ntsc_scale", (float)1.099999);
