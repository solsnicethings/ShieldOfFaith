/*
ShaderGlass preset retro-crisis/720p-Steam-Deck / RC GDV-NTSC - SNES - Dirty imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis720pSteamDeckRCGDVNTSCSNESDirtyPresetDef : public PresetDef
{
public:
	RetroCrisis720pSteamDeckRCGDVNTSCSNESDirtyPresetDef() : PresetDef{}
	{
		Name = "RC GDV-NTSC - SNES - Dirty";
...
.Param("wrap_mode", "clamp_to_border"));
            ...
            OverrideParam("bloom", (float)0.500001);
            OverrideParam("bloom_dist", (float)0.000000);
            ...
            OverrideParam("hmask1", (float)1.000000);
            OverrideParam("m_glow", (float)1.000000);
            OverrideParam("mask_bloom", (float)0.200001);
            ...
            OverrideParam("scangamma", (float)1.999999);
