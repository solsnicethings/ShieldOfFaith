/*
ShaderGlass preset retro-crisis/720p-Steam-Deck / RC GDV-NTSC - PCE Composite 100 imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis720pSteamDeckRCGDVNTSCPCEComposite100PresetDef : public PresetDef
{
public:
	RetroCrisis720pSteamDeckRCGDVNTSCPCEComposite100PresetDef() : PresetDef{}
	{
		Name = "RC GDV-NTSC - PCE Composite 100";
...
.Param("wrap_mode", "clamp_to_border"));
            OverrideParam("addnoised", (float)0.200000);
            OverrideParam("beam_min", (float)1.999999);
            OverrideParam("bloom", (float)0.050000);
            OverrideParam("deconrb", (float)1.500000);
            OverrideParam("deconrby", (float)1.500000);
            OverrideParam("deconrr", (float)-3.000000);
            OverrideParam("deconrry", (float)-3.000000);
            OverrideParam("gsl", (float)-1.000000);
            OverrideParam("inter", (float)225.000000);
            OverrideParam("interm", (float)2.000000);
            OverrideParam("intres", (float)1.000000);
            OverrideParam("mask_bloom", (float)0.050000);
            OverrideParam("mask_gamma", (float)5.000000);
            OverrideParam("mask_zoom", (float)-1.000000);
            ...
            OverrideParam("ntsc_scale", (float)1.250000);
            OverrideParam("pre_bb", (float)1.100000);
            ...
            OverrideParam("wp_saturation", (float)0.800000);
	}
};
}
