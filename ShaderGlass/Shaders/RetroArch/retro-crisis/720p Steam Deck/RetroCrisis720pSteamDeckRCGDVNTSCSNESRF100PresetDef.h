/*
ShaderGlass preset retro-crisis/720p-Steam-Deck / RC GDV-NTSC - SNES RF 100 imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis720pSteamDeckRCGDVNTSCSNESRF100PresetDef : public PresetDef
{
public:
	RetroCrisis720pSteamDeckRCGDVNTSCSNESRF100PresetDef() : PresetDef{}
	{
		Name = "RC GDV-NTSC - SNES RF 100";
...
.Param("wrap_mode", "clamp_to_border"));
            OverrideParam("CSHARPEN", (float)1.000000);
            OverrideParam("addnoised", (float)0.200000);
            OverrideParam("barintensity", (float)0.010000);
            OverrideParam("barspeed", (float)25.000000);
            OverrideParam("beam_min", (float)0.500000);
            OverrideParam("bloom", (float)0.100000);
            OverrideParam("deconrb", (float)-3.000000);
            ...
            OverrideParam("wp_saturation", (float)0.700000);
	}
};
}
