/*
ShaderGlass preset retro-crisis/720p-Steam-Deck / RC GDV-NTSC - SNES - Clean imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis720pSteamDeckRCGDVNTSCSNESCleanPresetDef : public PresetDef
{
public:
	RetroCrisis720pSteamDeckRCGDVNTSCSNESCleanPresetDef() : PresetDef{}
	{
		Name = "RC GDV-NTSC - SNES - Clean";
