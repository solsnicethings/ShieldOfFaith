/*
ShaderGlass preset retro-crisis/720p-Steam-Deck / RC GDV-NTSC - NES Composite 100 imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis720pSteamDeckRCGDVNTSCNESComposite100PresetDef : public PresetDef
{
public:
	RetroCrisis720pSteamDeckRCGDVNTSCNESComposite100PresetDef() : PresetDef{}
	{
		Name = "RC GDV-NTSC - NES Composite 100";
...
.Param("wrap_mode", "clamp_to_border"));
            ...
            OverrideParam("mask_gamma", (float)1.999998);
            ...
            OverrideParam("overscanX", (float)5.000000);
