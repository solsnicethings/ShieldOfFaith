/*
ShaderGlass preset retro-crisis/720p-Steam-Deck / RC GDV-NTSC - NES RGB 100 imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis720pSteamDeckRCGDVNTSCNESRGB100PresetDef : public PresetDef
{
public:
	RetroCrisis720pSteamDeckRCGDVNTSCNESRGB100PresetDef() : PresetDef{}
	{
		Name = "RC GDV-NTSC - NES RGB 100";
...
.Param("scale_type_x", "source")
.Param("scale_type_y", "source")
.Param("scale_x", "7.000000")
.Param("scale_y", "7.000000")
.Param("srgb_framebuffer", "false")
.Param("wrap_mode", "clamp_to_border"));
...
.Param("wrap_mode", "clamp_to_border"));
            ...
            OverrideParam("barintensity", (float)0.010001);
            OverrideParam("barspeed", (float)60.000000);
            OverrideParam("beam_min", (float)2.149999);
            ...
            OverrideParam("maskboost", (float)1.500000);
