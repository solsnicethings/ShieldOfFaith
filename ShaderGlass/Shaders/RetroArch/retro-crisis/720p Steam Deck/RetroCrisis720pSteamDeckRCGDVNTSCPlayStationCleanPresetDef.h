/*
ShaderGlass preset retro-crisis/720p-Steam-Deck / RC GDV-NTSC - PlayStation - Clean imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis720pSteamDeckRCGDVNTSCPlayStationCleanPresetDef : public PresetDef
{
public:
	RetroCrisis720pSteamDeckRCGDVNTSCPlayStationCleanPresetDef() : PresetDef{}
	{
		Name = "RC GDV-NTSC - PlayStation - Clean";
...
.Param("wrap_mode", "clamp_to_border"));
            OverrideParam("beam_min", (float)2.499999);
            OverrideParam("c_shape", (float)0.600000);
            OverrideParam("csize", (float)0.000000);
