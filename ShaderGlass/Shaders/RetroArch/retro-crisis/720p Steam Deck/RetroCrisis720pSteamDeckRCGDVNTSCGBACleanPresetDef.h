/*
ShaderGlass preset retro-crisis/720p-Steam-Deck / RC GDV-NTSC - GBA - Clean imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis720pSteamDeckRCGDVNTSCGBACleanPresetDef : public PresetDef
{
public:
	RetroCrisis720pSteamDeckRCGDVNTSCGBACleanPresetDef() : PresetDef{}
	{
		Name = "RC GDV-NTSC - GBA - Clean";
...
.Param("wrap_mode", "clamp_to_border"));
            ...
            OverrideParam("beam_min", (float)10.000000);
            OverrideParam("cust_artifacting", (float)0.400000);
            OverrideParam("cust_fringing", (float)0.400000);
            ...
            OverrideParam("mcut", (float)1.000000);
