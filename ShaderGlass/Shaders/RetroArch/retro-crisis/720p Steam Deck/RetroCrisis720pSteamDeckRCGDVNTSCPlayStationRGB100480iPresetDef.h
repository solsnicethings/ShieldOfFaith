/*
ShaderGlass preset retro-crisis/720p-Steam-Deck / RC GDV-NTSC - PlayStation RGB 100 - 480i imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis720pSteamDeckRCGDVNTSCPlayStationRGB100480iPresetDef : public PresetDef
{
public:
	RetroCrisis720pSteamDeckRCGDVNTSCPlayStationRGB100480iPresetDef() : PresetDef{}
	{
		Name = "RC GDV-NTSC - PlayStation RGB 100 - 480i";
...
.Param("wrap_mode", "clamp_to_border"));
            ...
            OverrideParam("mask_gamma", (float)1.899999);
            ...
            OverrideParam("scan_falloff", (float)1.500000);
