/*
ShaderGlass preset retro-crisis/720p-Steam-Deck / RC GDV-NTSC - GBA - Dirty imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis720pSteamDeckRCGDVNTSCGBADirtyPresetDef : public PresetDef
{
public:
	RetroCrisis720pSteamDeckRCGDVNTSCGBADirtyPresetDef() : PresetDef{}
	{
		Name = "RC GDV-NTSC - GBA - Dirty";
...
.Param("wrap_mode", "clamp_to_border"));
            ...
            OverrideParam("ntsc_cscale", (float)1.000000);
