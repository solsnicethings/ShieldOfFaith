/*
ShaderGlass preset retro-crisis/4K-Curved / RC GDV-NTSC - DOS - High Res - Dirty imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis4KCurvedRCGDVNTSCDOSHighResDirtyPresetDef : public PresetDef
{
public:
	RetroCrisis4KCurvedRCGDVNTSCDOSHighResDirtyPresetDef() : PresetDef{}
	{
		Name = "RC GDV-NTSC - DOS - High Res - Dirty";
...
.Param("wrap_mode", "clamp_to_border"));
            ...
            OverrideParam("double_slot", (float)1.000000);
            OverrideParam("gsl", (float)1.000000);
            OverrideParam("intres", (float)0.500000);
            OverrideParam("m_glow", (float)2.000000);
            OverrideParam("maskDark", (float)2.000000);
            OverrideParam("maskLight", (float)2.000000);
            OverrideParam("mask_bloom", (float)1.000000);
            OverrideParam("mask_gamma", (float)3.499997);
            ...
            OverrideParam("ntsc_cscale", (float)1.500000);
            ...
            OverrideParam("scanline2", (float)12.000000);
            OverrideParam("shadowMask", (float)11.000000);
