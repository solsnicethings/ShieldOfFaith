/*
ShaderGlass preset retro-crisis/4K-Curved / RC GDV-NTSC - PCE RGB 100 imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis4KCurvedRCGDVNTSCPCERGB100PresetDef : public PresetDef
{
public:
	RetroCrisis4KCurvedRCGDVNTSCPCERGB100PresetDef() : PresetDef{}
	{
