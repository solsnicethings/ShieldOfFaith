/*
ShaderGlass preset retro-crisis/4K-Curved / RC GDV-NTSC - Arcade - Clean imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis4KCurvedRCGDVNTSCArcadeCleanPresetDef : public PresetDef
{
public:
	RetroCrisis4KCurvedRCGDVNTSCArcadeCleanPresetDef() : PresetDef{}
	{
