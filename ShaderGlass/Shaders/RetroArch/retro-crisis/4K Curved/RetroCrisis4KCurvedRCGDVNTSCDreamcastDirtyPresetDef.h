/*
ShaderGlass preset retro-crisis/4K-Curved / RC GDV-NTSC - Dreamcast - Dirty imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis4KCurvedRCGDVNTSCDreamcastDirtyPresetDef : public PresetDef
{
public:
	RetroCrisis4KCurvedRCGDVNTSCDreamcastDirtyPresetDef() : PresetDef{}
	{
