/*
ShaderGlass preset retro-crisis/4K-Curved / RC GDV-NTSC - DOS - Low Res - Dirty imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis4KCurvedRCGDVNTSCDOSLowResDirtyPresetDef : public PresetDef
{
public:
	RetroCrisis4KCurvedRCGDVNTSCDOSLowResDirtyPresetDef() : PresetDef{}
	{
		Name = "RC GDV-NTSC - DOS - Low Res - Dirty";
