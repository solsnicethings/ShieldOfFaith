/*
ShaderGlass preset retro-crisis/4K-Curved / RC GDV-NTSC - SNES - Dirty imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis4KCurvedRCGDVNTSCSNESDirtyPresetDef : public PresetDef
{
public:
	RetroCrisis4KCurvedRCGDVNTSCSNESDirtyPresetDef() : PresetDef{}
	{
