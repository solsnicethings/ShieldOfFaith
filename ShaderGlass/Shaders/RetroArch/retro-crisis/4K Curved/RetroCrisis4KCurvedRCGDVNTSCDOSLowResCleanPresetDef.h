/*
ShaderGlass preset retro-crisis/4K-Curved / RC GDV-NTSC - DOS - Low Res - Clean imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis4KCurvedRCGDVNTSCDOSLowResCleanPresetDef : public PresetDef
{
public:
	RetroCrisis4KCurvedRCGDVNTSCDOSLowResCleanPresetDef() : PresetDef{}
	{
		Name = "RC GDV-NTSC - DOS - Low Res - Clean";
