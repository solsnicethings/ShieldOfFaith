/*
ShaderGlass preset retro-crisis/4K-Curved / RC GDV-NTSC - SNES - Clean imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis4KCurvedRCGDVNTSCSNESCleanPresetDef : public PresetDef
{
public:
	RetroCrisis4KCurvedRCGDVNTSCSNESCleanPresetDef() : PresetDef{}
	{
