/*
ShaderGlass preset retro-crisis/4K-Curved / RC GDV-NTSC - PCE imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis4KCurvedRCGDVNTSCPCEPresetDef : public PresetDef
{
public:
	RetroCrisis4KCurvedRCGDVNTSCPCEPresetDef() : PresetDef{}
	{
