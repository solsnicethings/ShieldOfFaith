/*
ShaderGlass preset retro-crisis/4K-Curved / RC GDV-NTSC - VHS 720p - Curved imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis4KCurvedRCGDVNTSCVHS720pCurvedPresetDef : public PresetDef
{
public:
	RetroCrisis4KCurvedRCGDVNTSCVHS720pCurvedPresetDef() : PresetDef{}
	{
		Name = "RC GDV-NTSC - VHS 720p - Curved";
...
.Param("wrap_mode", "clamp_to_border"));
            ...
            OverrideParam("intres", (float)2.000000);
