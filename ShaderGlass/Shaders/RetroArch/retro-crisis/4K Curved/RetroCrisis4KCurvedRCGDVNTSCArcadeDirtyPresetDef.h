/*
ShaderGlass preset retro-crisis/4K-Curved / RC GDV-NTSC - Arcade - Dirty imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis4KCurvedRCGDVNTSCArcadeDirtyPresetDef : public PresetDef
{
public:
	RetroCrisis4KCurvedRCGDVNTSCArcadeDirtyPresetDef() : PresetDef{}
	{
