/*
ShaderGlass preset retro-crisis/4K-Curved / RC GDV-NTSC - SNES RGB 100 imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis4KCurvedRCGDVNTSCSNESRGB100PresetDef : public PresetDef
{
public:
	RetroCrisis4KCurvedRCGDVNTSCSNESRGB100PresetDef() : PresetDef{}
	{
