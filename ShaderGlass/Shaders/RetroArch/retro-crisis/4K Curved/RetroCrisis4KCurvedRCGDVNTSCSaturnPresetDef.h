/*
ShaderGlass preset retro-crisis/4K-Curved / RC GDV-NTSC - Saturn imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis4KCurvedRCGDVNTSCSaturnPresetDef : public PresetDef
{
public:
	RetroCrisis4KCurvedRCGDVNTSCSaturnPresetDef() : PresetDef{}
	{
