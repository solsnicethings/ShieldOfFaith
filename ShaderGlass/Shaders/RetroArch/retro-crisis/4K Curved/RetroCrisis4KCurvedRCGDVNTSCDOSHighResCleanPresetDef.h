/*
ShaderGlass preset retro-crisis/4K-Curved / RC GDV-NTSC - DOS - High Res - Clean imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis4KCurvedRCGDVNTSCDOSHighResCleanPresetDef : public PresetDef
{
public:
	RetroCrisis4KCurvedRCGDVNTSCDOSHighResCleanPresetDef() : PresetDef{}
	{
		Name = "RC GDV-NTSC - DOS - High Res - Clean";
