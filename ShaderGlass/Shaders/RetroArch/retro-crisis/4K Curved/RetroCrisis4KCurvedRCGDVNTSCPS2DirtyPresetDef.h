/*
ShaderGlass preset retro-crisis/4K-Curved / RC GDV-NTSC - PS2 - Dirty imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis4KCurvedRCGDVNTSCPS2DirtyPresetDef : public PresetDef
{
public:
	RetroCrisis4KCurvedRCGDVNTSCPS2DirtyPresetDef() : PresetDef{}
	{
