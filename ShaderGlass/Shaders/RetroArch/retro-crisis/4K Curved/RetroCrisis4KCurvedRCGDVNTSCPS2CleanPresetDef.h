/*
ShaderGlass preset retro-crisis/4K-Curved / RC GDV-NTSC - PS2 - Clean imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis4KCurvedRCGDVNTSCPS2CleanPresetDef : public PresetDef
{
public:
	RetroCrisis4KCurvedRCGDVNTSCPS2CleanPresetDef() : PresetDef{}
	{
