/*
ShaderGlass preset retro-crisis/4K-Curved / RC GDV-NTSC - VHS 2160p - Curved imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis4KCurvedRCGDVNTSCVHS2160pCurvedPresetDef : public PresetDef
{
public:
	RetroCrisis4KCurvedRCGDVNTSCVHS2160pCurvedPresetDef() : PresetDef{}
	{
		Name = "RC GDV-NTSC - VHS 2160p - Curved";
