/*
ShaderGlass preset retro-crisis/4K-Curved / RC GDV-NTSC - VHS 240p - Curved imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis4KCurvedRCGDVNTSCVHS240pCurvedPresetDef : public PresetDef
{
public:
	RetroCrisis4KCurvedRCGDVNTSCVHS240pCurvedPresetDef() : PresetDef{}
	{
		Name = "RC GDV-NTSC - VHS 240p - Curved";
