/*
ShaderGlass preset retro-crisis/4K-Curved / RC GDV-NTSC - Mega Drive - Dirty imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis4KCurvedRCGDVNTSCMegaDriveDirtyPresetDef : public PresetDef
{
public:
	RetroCrisis4KCurvedRCGDVNTSCMegaDriveDirtyPresetDef() : PresetDef{}
	{
