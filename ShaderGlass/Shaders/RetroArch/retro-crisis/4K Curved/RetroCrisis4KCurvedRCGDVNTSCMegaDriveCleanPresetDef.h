/*
ShaderGlass preset retro-crisis/4K-Curved / RC GDV-NTSC - Mega Drive - Clean imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis4KCurvedRCGDVNTSCMegaDriveCleanPresetDef : public PresetDef
{
public:
	RetroCrisis4KCurvedRCGDVNTSCMegaDriveCleanPresetDef() : PresetDef{}
	{
