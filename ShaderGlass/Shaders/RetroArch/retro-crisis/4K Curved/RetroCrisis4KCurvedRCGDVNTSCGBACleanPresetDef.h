/*
ShaderGlass preset retro-crisis/4K-Curved / RC GDV-NTSC - GBA - Clean imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis4KCurvedRCGDVNTSCGBACleanPresetDef : public PresetDef
{
public:
	RetroCrisis4KCurvedRCGDVNTSCGBACleanPresetDef() : PresetDef{}
	{
