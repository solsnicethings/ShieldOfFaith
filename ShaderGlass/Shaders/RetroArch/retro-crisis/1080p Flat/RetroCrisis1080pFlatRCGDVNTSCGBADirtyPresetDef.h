/*
ShaderGlass preset retro-crisis/1080p-Flat / RC GDV-NTSC - GBA - Dirty imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis1080pFlatRCGDVNTSCGBADirtyPresetDef : public PresetDef
{
public:
	RetroCrisis1080pFlatRCGDVNTSCGBADirtyPresetDef() : PresetDef{}
	{
