/*
ShaderGlass preset retro-crisis/1080p-Flat / RC GDV-NTSC - PlayStation - Dirty imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis1080pFlatRCGDVNTSCPlayStationDirtyPresetDef : public PresetDef
{
public:
	RetroCrisis1080pFlatRCGDVNTSCPlayStationDirtyPresetDef() : PresetDef{}
	{
		Name = "RC GDV-NTSC - PlayStation - Dirty";
...
.Param("wrap_mode", "clamp_to_border"));
            ...
            OverrideParam("maskstr", (float)0.900000);
            ...
            OverrideParam("slotmask", (float)0.750000);
