/*
ShaderGlass preset retro-crisis/1080p-Flat / RC GDV-NTSC - SGB - Clean imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis1080pFlatRCGDVNTSCSGBCleanPresetDef : public PresetDef
{
public:
	RetroCrisis1080pFlatRCGDVNTSCSGBCleanPresetDef() : PresetDef{}
	{
