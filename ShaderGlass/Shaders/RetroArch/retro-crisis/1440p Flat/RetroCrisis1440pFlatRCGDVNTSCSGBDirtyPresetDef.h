/*
ShaderGlass preset retro-crisis/1440p-Flat / RC GDV-NTSC - SGB - Dirty imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis1440pFlatRCGDVNTSCSGBDirtyPresetDef : public PresetDef
{
public:
	RetroCrisis1440pFlatRCGDVNTSCSGBDirtyPresetDef() : PresetDef{}
	{
