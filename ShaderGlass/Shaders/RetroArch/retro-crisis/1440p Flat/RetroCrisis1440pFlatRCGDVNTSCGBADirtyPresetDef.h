/*
ShaderGlass preset retro-crisis/1440p-Flat / RC GDV-NTSC - GBA - Dirty imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis1440pFlatRCGDVNTSCGBADirtyPresetDef : public PresetDef
{
public:
	RetroCrisis1440pFlatRCGDVNTSCGBADirtyPresetDef() : PresetDef{}
	{
