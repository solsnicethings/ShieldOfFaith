/*
ShaderGlass preset retro-crisis/4K-Flat / RC GDV-NTSC - DOS - Low Res - Dirty imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis4KFlatRCGDVNTSCDOSLowResDirtyPresetDef : public PresetDef
{
public:
	RetroCrisis4KFlatRCGDVNTSCDOSLowResDirtyPresetDef() : PresetDef{}
	{
