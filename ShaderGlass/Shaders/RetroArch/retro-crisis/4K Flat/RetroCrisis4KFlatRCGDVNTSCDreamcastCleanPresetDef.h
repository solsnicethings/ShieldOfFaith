/*
ShaderGlass preset retro-crisis/4K-Flat / RC GDV-NTSC - Dreamcast - Clean imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis4KFlatRCGDVNTSCDreamcastCleanPresetDef : public PresetDef
{
public:
	RetroCrisis4KFlatRCGDVNTSCDreamcastCleanPresetDef() : PresetDef{}
	{
