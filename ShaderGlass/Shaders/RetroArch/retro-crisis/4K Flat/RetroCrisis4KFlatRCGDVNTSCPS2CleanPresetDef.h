/*
ShaderGlass preset retro-crisis/4K-Flat / RC GDV-NTSC - PS2 - Clean imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis4KFlatRCGDVNTSCPS2CleanPresetDef : public PresetDef
{
public:
	RetroCrisis4KFlatRCGDVNTSCPS2CleanPresetDef() : PresetDef{}
	{
