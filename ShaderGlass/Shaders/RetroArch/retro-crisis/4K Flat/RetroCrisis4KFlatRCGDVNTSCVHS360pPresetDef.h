/*
ShaderGlass preset retro-crisis/4K-Flat / RC GDV-NTSC - VHS 360p imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis4KFlatRCGDVNTSCVHS360pPresetDef : public PresetDef
{
public:
	RetroCrisis4KFlatRCGDVNTSCVHS360pPresetDef() : PresetDef{}
	{
