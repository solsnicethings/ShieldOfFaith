/*
ShaderGlass preset retro-crisis/4K-Flat / RC GDV-NTSC - SNES - Dirty imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis4KFlatRCGDVNTSCSNESDirtyPresetDef : public PresetDef
{
public:
	RetroCrisis4KFlatRCGDVNTSCSNESDirtyPresetDef() : PresetDef{}
	{
