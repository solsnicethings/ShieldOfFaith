/*
ShaderGlass preset retro-crisis/4K-Flat / RC GDV-NTSC - PS2 imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis4KFlatRCGDVNTSCPS2PresetDef : public PresetDef
{
public:
	RetroCrisis4KFlatRCGDVNTSCPS2PresetDef() : PresetDef{}
	{
