/*
ShaderGlass preset retro-crisis/4K-Flat / RC GDV-NTSC - Dreamcast - Dirty imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis4KFlatRCGDVNTSCDreamcastDirtyPresetDef : public PresetDef
{
public:
	RetroCrisis4KFlatRCGDVNTSCDreamcastDirtyPresetDef() : PresetDef{}
	{
