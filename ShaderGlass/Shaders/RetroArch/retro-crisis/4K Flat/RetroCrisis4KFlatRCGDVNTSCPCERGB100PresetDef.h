/*
ShaderGlass preset retro-crisis/4K-Flat / RC GDV-NTSC - PCE RGB 100 imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis4KFlatRCGDVNTSCPCERGB100PresetDef : public PresetDef
{
public:
	RetroCrisis4KFlatRCGDVNTSCPCERGB100PresetDef() : PresetDef{}
	{
