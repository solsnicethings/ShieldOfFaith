/*
ShaderGlass preset retro-crisis/4K-Flat / RC GDV-NTSC - Arcade - Dirty imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis4KFlatRCGDVNTSCArcadeDirtyPresetDef : public PresetDef
{
public:
	RetroCrisis4KFlatRCGDVNTSCArcadeDirtyPresetDef() : PresetDef{}
	{
