/*
ShaderGlass preset retro-crisis/4K-Flat / RC GDV-NTSC - SNES - Clean imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis4KFlatRCGDVNTSCSNESCleanPresetDef : public PresetDef
{
public:
	RetroCrisis4KFlatRCGDVNTSCSNESCleanPresetDef() : PresetDef{}
	{
