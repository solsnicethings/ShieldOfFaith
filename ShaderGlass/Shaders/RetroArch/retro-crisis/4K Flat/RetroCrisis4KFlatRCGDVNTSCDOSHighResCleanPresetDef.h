/*
ShaderGlass preset retro-crisis/4K-Flat / RC GDV-NTSC - DOS - High Res - Clean imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis4KFlatRCGDVNTSCDOSHighResCleanPresetDef : public PresetDef
{
public:
	RetroCrisis4KFlatRCGDVNTSCDOSHighResCleanPresetDef() : PresetDef{}
	{
