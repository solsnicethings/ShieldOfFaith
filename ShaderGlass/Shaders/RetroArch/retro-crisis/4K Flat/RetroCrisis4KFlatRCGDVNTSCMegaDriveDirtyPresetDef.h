/*
ShaderGlass preset retro-crisis/4K-Flat / RC GDV-NTSC - Mega Drive - Dirty imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis4KFlatRCGDVNTSCMegaDriveDirtyPresetDef : public PresetDef
{
public:
	RetroCrisis4KFlatRCGDVNTSCMegaDriveDirtyPresetDef() : PresetDef{}
	{
