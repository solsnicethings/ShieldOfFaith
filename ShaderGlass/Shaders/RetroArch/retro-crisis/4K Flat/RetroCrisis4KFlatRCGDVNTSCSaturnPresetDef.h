/*
ShaderGlass preset retro-crisis/4K-Flat / RC GDV-NTSC - Saturn imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis4KFlatRCGDVNTSCSaturnPresetDef : public PresetDef
{
public:
	RetroCrisis4KFlatRCGDVNTSCSaturnPresetDef() : PresetDef{}
	{
