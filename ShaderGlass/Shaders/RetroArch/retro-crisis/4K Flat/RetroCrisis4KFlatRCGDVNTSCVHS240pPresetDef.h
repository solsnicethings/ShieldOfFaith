/*
ShaderGlass preset retro-crisis/4K-Flat / RC GDV-NTSC - VHS 240p imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis4KFlatRCGDVNTSCVHS240pPresetDef : public PresetDef
{
public:
	RetroCrisis4KFlatRCGDVNTSCVHS240pPresetDef() : PresetDef{}
	{
