/*
ShaderGlass preset retro-crisis/4K-Flat / RC GDV-NTSC - N64 imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis4KFlatRCGDVNTSCN64PresetDef : public PresetDef
{
public:
	RetroCrisis4KFlatRCGDVNTSCN64PresetDef() : PresetDef{}
	{
