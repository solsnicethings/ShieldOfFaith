/*
ShaderGlass preset retro-crisis/4K-Flat / RC GDV-NTSC - SNES RGB 100 imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis4KFlatRCGDVNTSCSNESRGB100PresetDef : public PresetDef
{
public:
	RetroCrisis4KFlatRCGDVNTSCSNESRGB100PresetDef() : PresetDef{}
	{
