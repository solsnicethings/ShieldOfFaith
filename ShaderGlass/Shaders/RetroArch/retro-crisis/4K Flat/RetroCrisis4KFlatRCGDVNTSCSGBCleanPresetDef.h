/*
ShaderGlass preset retro-crisis/4K-Flat / RC GDV-NTSC - SGB - Clean imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis4KFlatRCGDVNTSCSGBCleanPresetDef : public PresetDef
{
public:
	RetroCrisis4KFlatRCGDVNTSCSGBCleanPresetDef() : PresetDef{}
	{
