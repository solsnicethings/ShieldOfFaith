/*
ShaderGlass preset retro-crisis/4K-Flat / RC GDV-NTSC - GBA - Clean imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis4KFlatRCGDVNTSCGBACleanPresetDef : public PresetDef
{
public:
	RetroCrisis4KFlatRCGDVNTSCGBACleanPresetDef() : PresetDef{}
	{
