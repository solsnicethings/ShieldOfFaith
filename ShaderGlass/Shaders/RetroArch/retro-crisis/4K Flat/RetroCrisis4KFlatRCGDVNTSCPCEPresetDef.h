/*
ShaderGlass preset retro-crisis/4K-Flat / RC GDV-NTSC - PCE imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis4KFlatRCGDVNTSCPCEPresetDef : public PresetDef
{
public:
	RetroCrisis4KFlatRCGDVNTSCPCEPresetDef() : PresetDef{}
	{
