/*
ShaderGlass preset retro-crisis/4K-Flat / RC GDV-NTSC - PS2 - Dirty imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis4KFlatRCGDVNTSCPS2DirtyPresetDef : public PresetDef
{
public:
	RetroCrisis4KFlatRCGDVNTSCPS2DirtyPresetDef() : PresetDef{}
	{
