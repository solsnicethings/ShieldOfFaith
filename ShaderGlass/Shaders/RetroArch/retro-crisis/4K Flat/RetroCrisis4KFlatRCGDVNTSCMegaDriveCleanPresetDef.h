/*
ShaderGlass preset retro-crisis/4K-Flat / RC GDV-NTSC - Mega Drive - Clean imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis4KFlatRCGDVNTSCMegaDriveCleanPresetDef : public PresetDef
{
public:
	RetroCrisis4KFlatRCGDVNTSCMegaDriveCleanPresetDef() : PresetDef{}
	{
