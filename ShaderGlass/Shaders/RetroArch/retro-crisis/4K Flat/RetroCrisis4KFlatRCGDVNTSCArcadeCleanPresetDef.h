/*
ShaderGlass preset retro-crisis/4K-Flat / RC GDV-NTSC - Arcade - Clean imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis4KFlatRCGDVNTSCArcadeCleanPresetDef : public PresetDef
{
public:
	RetroCrisis4KFlatRCGDVNTSCArcadeCleanPresetDef() : PresetDef{}
	{
