/*
ShaderGlass preset retro-crisis/4K-Flat / RC GDV-NTSC - DOS - High Res - Dirty imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis4KFlatRCGDVNTSCDOSHighResDirtyPresetDef : public PresetDef
{
public:
	RetroCrisis4KFlatRCGDVNTSCDOSHighResDirtyPresetDef() : PresetDef{}
	{
