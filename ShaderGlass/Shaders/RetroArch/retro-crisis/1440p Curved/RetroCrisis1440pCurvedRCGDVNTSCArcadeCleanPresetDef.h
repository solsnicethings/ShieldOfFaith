/*
ShaderGlass preset retro-crisis/1440p-Curved / RC GDV-NTSC - Arcade - Clean imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis1440pCurvedRCGDVNTSCArcadeCleanPresetDef : public PresetDef
{
public:
	RetroCrisis1440pCurvedRCGDVNTSCArcadeCleanPresetDef() : PresetDef{}
	{
		Name = "RC GDV-NTSC - Arcade - Clean";
...
.Param("wrap_mode", "clamp_to_border"));
            ...
            OverrideParam("ntsc_scale", (float)2.000000);
