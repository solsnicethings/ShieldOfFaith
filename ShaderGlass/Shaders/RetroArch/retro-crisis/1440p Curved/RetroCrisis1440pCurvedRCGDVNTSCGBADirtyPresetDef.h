/*
ShaderGlass preset retro-crisis/1440p-Curved / RC GDV-NTSC - GBA - Dirty imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis1440pCurvedRCGDVNTSCGBADirtyPresetDef : public PresetDef
{
public:
	RetroCrisis1440pCurvedRCGDVNTSCGBADirtyPresetDef() : PresetDef{}
	{
