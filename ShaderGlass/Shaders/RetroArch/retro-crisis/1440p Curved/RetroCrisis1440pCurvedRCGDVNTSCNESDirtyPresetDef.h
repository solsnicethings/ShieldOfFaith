/*
ShaderGlass preset retro-crisis/1440p-Curved / RC GDV-NTSC - NES - Dirty imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis1440pCurvedRCGDVNTSCNESDirtyPresetDef : public PresetDef
{
public:
	RetroCrisis1440pCurvedRCGDVNTSCNESDirtyPresetDef() : PresetDef{}
	{
		Name = "RC GDV-NTSC - NES - Dirty";
...
.Param("wrap_mode", "clamp_to_border"));
            ...
            OverrideParam("scan_falloff", (float)1.000000);
