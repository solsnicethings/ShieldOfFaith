/*
ShaderGlass preset retro-crisis/1440p-Curved / RC GDV-NTSC - PS2 - Clean imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis1440pCurvedRCGDVNTSCPS2CleanPresetDef : public PresetDef
{
public:
	RetroCrisis1440pCurvedRCGDVNTSCPS2CleanPresetDef() : PresetDef{}
	{
		Name = "RC GDV-NTSC - PS2 - Clean";
...
.Param("wrap_mode", "clamp_to_border"));
            ...
            OverrideParam("beam_max", (float)0.500000);
            ...
            OverrideParam("scanline1", (float)5.000000);
