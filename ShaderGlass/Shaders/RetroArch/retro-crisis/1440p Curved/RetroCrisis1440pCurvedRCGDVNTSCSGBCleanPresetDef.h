/*
ShaderGlass preset retro-crisis/1440p-Curved / RC GDV-NTSC - SGB - Clean imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis1440pCurvedRCGDVNTSCSGBCleanPresetDef : public PresetDef
{
public:
	RetroCrisis1440pCurvedRCGDVNTSCSGBCleanPresetDef() : PresetDef{}
	{
