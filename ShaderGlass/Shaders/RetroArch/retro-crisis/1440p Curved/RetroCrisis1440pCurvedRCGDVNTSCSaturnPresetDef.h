/*
ShaderGlass preset retro-crisis/1440p-Curved / RC GDV-NTSC - Saturn imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis1440pCurvedRCGDVNTSCSaturnPresetDef : public PresetDef
{
public:
	RetroCrisis1440pCurvedRCGDVNTSCSaturnPresetDef() : PresetDef{}
	{
