/*
ShaderGlass preset retro-crisis/1080p-Curved / RC GDV-NTSC - SGB - Clean imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis1080pCurvedRCGDVNTSCSGBCleanPresetDef : public PresetDef
{
public:
	RetroCrisis1080pCurvedRCGDVNTSCSGBCleanPresetDef() : PresetDef{}
	{
