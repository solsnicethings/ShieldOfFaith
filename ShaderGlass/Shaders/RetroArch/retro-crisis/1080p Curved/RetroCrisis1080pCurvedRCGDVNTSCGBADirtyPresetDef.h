/*
ShaderGlass preset retro-crisis/1080p-Curved / RC GDV-NTSC - GBA - Dirty imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis1080pCurvedRCGDVNTSCGBADirtyPresetDef : public PresetDef
{
public:
	RetroCrisis1080pCurvedRCGDVNTSCGBADirtyPresetDef() : PresetDef{}
	{
