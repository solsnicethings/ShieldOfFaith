/*
ShaderGlass preset retro-crisis/1080p-Curved / RC GDV-NTSC - PS2 - Dirty imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis1080pCurvedRCGDVNTSCPS2DirtyPresetDef : public PresetDef
{
public:
	RetroCrisis1080pCurvedRCGDVNTSCPS2DirtyPresetDef() : PresetDef{}
	{
		Name = "RC GDV-NTSC - PS2 - Dirty";
