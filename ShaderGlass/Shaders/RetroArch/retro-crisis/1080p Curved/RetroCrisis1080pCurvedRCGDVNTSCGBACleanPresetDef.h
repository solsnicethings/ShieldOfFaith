/*
ShaderGlass preset retro-crisis/1080p-Curved / RC GDV-NTSC - GBA - Clean imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis1080pCurvedRCGDVNTSCGBACleanPresetDef : public PresetDef
{
public:
	RetroCrisis1080pCurvedRCGDVNTSCGBACleanPresetDef() : PresetDef{}
	{
