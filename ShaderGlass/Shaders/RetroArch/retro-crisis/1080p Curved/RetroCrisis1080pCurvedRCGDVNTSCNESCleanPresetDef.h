/*
ShaderGlass preset retro-crisis/1080p-Curved / RC GDV-NTSC - NES - Clean imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis1080pCurvedRCGDVNTSCNESCleanPresetDef : public PresetDef
{
public:
	RetroCrisis1080pCurvedRCGDVNTSCNESCleanPresetDef() : PresetDef{}
	{
		Name = "RC GDV-NTSC - NES - Clean";
...
.Param("wrap_mode", "clamp_to_border"));
            ...
            OverrideParam("ntsc_cscale", (float)1.250000);
            OverrideParam("ntsc_scale", (float)1.500000);
