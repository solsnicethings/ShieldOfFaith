/*
ShaderGlass preset retro-crisis/1080p-Curved / RC GDV-NTSC - PS2 imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis1080pCurvedRCGDVNTSCPS2PresetDef : public PresetDef
{
public:
	RetroCrisis1080pCurvedRCGDVNTSCPS2PresetDef() : PresetDef{}
	{
		Name = "RC GDV-NTSC - PS2";
