/*
ShaderGlass preset retro-crisis/1080p-Curved / RC GDV-NTSC - SGB - Dirty imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis1080pCurvedRCGDVNTSCSGBDirtyPresetDef : public PresetDef
{
public:
	RetroCrisis1080pCurvedRCGDVNTSCSGBDirtyPresetDef() : PresetDef{}
	{
