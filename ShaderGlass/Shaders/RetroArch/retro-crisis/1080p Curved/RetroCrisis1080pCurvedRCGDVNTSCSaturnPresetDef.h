/*
ShaderGlass preset retro-crisis/1080p-Curved / RC GDV-NTSC - Saturn imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis1080pCurvedRCGDVNTSCSaturnPresetDef : public PresetDef
{
public:
	RetroCrisis1080pCurvedRCGDVNTSCSaturnPresetDef() : PresetDef{}
	{
