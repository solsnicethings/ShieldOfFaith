/*
ShaderGlass preset sonkun/slot-mask/flat-screen/4k / 25-j-warm-rgb imported from Sonkun:
...
namespace RetroArch
{
class SonkunSlotMaskFlatScreen4k254kCrtGuestAdvancedHdSlotMaskJWarmRgbPresetDef : public PresetDef
{
public:
	SonkunSlotMaskFlatScreen4k254kCrtGuestAdvancedHdSlotMaskJWarmRgbPresetDef() : PresetDef{}
	{
		Name = "25-j-warm-rgb";
