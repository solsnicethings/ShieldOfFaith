/*
ShaderGlass preset sonkun/slot-mask/flat-screen/4k / 21-j-warm-rf imported from Sonkun:
...
namespace RetroArch
{
class SonkunSlotMaskFlatScreen4k214kCrtGuestAdvancedHdSlotMaskJWarmRfPresetDef : public PresetDef
{
public:
	SonkunSlotMaskFlatScreen4k214kCrtGuestAdvancedHdSlotMaskJWarmRfPresetDef() : PresetDef{}
	{
		Name = "21-j-warm-rf";
