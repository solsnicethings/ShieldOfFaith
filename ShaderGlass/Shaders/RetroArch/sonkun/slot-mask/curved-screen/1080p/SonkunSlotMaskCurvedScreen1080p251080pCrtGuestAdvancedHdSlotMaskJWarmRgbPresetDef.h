/*
ShaderGlass preset sonkun/slot-mask/curved-screen/1080p / 25-j-warm-rgb imported from Sonkun:
...
namespace RetroArch
{
class SonkunSlotMaskCurvedScreen1080p251080pCrtGuestAdvancedHdSlotMaskJWarmRgbPresetDef : public PresetDef
{
public:
	SonkunSlotMaskCurvedScreen1080p251080pCrtGuestAdvancedHdSlotMaskJWarmRgbPresetDef() : PresetDef{}
	{
		Name = "25-j-warm-rgb";
