/*
ShaderGlass preset sonkun/aperture-grille/curved-screen/4k / 03-u-normal-composite-rainbow-artifacts imported from Sonkun:
...
namespace RetroArch
{
class SonkunApertureGrilleCurvedScreen4k034kCrtGuestAdvancedHdApertureGrilleUNormalCompositeRainbowArtifactsPresetDef : public PresetDef
{
public:
	SonkunApertureGrilleCurvedScreen4k034kCrtGuestAdvancedHdApertureGrilleUNormalCompositeRainbowArtifactsPresetDef() : PresetDef{}
	{
...
.Param("wrap_mode", "clamp_to_border"));
            ...
            OverrideParam("g_lum", (float)0.060000);
