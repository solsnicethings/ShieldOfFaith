/*
ShaderGlass preset sonkun/aperture-grille/curved-screen/4k / 21-j-warm-rf imported from Sonkun:
...
namespace RetroArch
{
class SonkunApertureGrilleCurvedScreen4k214kCrtGuestAdvancedHdApertureGrilleJWarmRfPresetDef : public PresetDef
{
public:
	SonkunApertureGrilleCurvedScreen4k214kCrtGuestAdvancedHdApertureGrilleJWarmRfPresetDef() : PresetDef{}
	{
		Name = "21-j-warm-rf";
