/*
ShaderGlass preset sonkun/aperture-grille/flat-screen/4k / 36-pal-warm-rf imported from Sonkun:
...
namespace RetroArch
{
class SonkunApertureGrilleFlatScreen4k364kCrtGuestAdvancedHdApertureGrillePalWarmRfPresetDef : public PresetDef
{
public:
	SonkunApertureGrilleFlatScreen4k364kCrtGuestAdvancedHdApertureGrillePalWarmRfPresetDef() : PresetDef{}
	{
		Name = "36-pal-warm-rf";
