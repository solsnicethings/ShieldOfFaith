/*
ShaderGlass preset sonkun/shadow-mask/curved-screen/1440p / 34-pal-normal-s-video imported from Sonkun:
...
namespace RetroArch
{
class SonkunShadowMaskCurvedScreen1440p341440pCrtGuestAdvancedHdShadowMaskPalNormalSVideoPresetDef : public PresetDef
{
public:
	SonkunShadowMaskCurvedScreen1440p341440pCrtGuestAdvancedHdShadowMaskPalNormalSVideoPresetDef() : PresetDef{}
	{
		Name = "34-pal-normal-s-video";
...
.Param("wrap_mode", "clamp_to_border"));
            OverrideParam("CB_MITIG_NEIGHBRS", (float)4.000000);
            ...
            OverrideParam("UseGamma", (float)0.000000);
            OverrideParam("VL_BLEND_LEVEL", (float)0.000000);
            OverrideParam("VL_MITIG_NEIGHBRS", (float)4.000000);
            ...
            OverrideParam("wp_temperature", (float)6904.000000);
	}
};
}
