/*
ShaderGlass preset sonkun/shadow-mask/curved-screen/1440p / 14-u-cool-s-video imported from Sonkun:
...
namespace RetroArch
{
class SonkunShadowMaskCurvedScreen1440p141440pCrtGuestAdvancedHdShadowMaskUCoolSVideoPresetDef : public PresetDef
{
public:
	SonkunShadowMaskCurvedScreen1440p141440pCrtGuestAdvancedHdShadowMaskUCoolSVideoPresetDef() : PresetDef{}
	{
		Name = "14-u-cool-s-video";
...
.Param("wrap_mode", "clamp_to_border"));
            ...
            OverrideParam("wp_temperature", (float)7504.000000);
	}
};
}
