/*
ShaderGlass preset sonkun/shadow-mask/curved-screen/1440p / 03-u-normal-composite-rainbow-artifacts imported from Sonkun:
...
namespace RetroArch
{
class SonkunShadowMaskCurvedScreen1440p031440pCrtGuestAdvancedHdShadowMaskUNormalCompositeRainbowArtifactsPresetDef : public PresetDef
{
public:
	SonkunShadowMaskCurvedScreen1440p031440pCrtGuestAdvancedHdShadowMaskUNormalCompositeRainbowArtifactsPresetDef() : PresetDef{}
	{
		Name = "03-u-normal-composite-rainbow-artifacts";
		Category = "sonkun/shadow-mask/curved-screen/1440p";
	}
...
.Param("wrap_mode", "clamp_to_border"));
            ...
            OverrideParam("cust_artifacting", (float)1.500000);
            ...
            OverrideParam("ntsc_taps", (float)11.000000);
            ...
            OverrideParam("wp_temperature", (float)7104.000000);
	}
};
}
